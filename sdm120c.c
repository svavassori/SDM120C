...
int main(int argc, char* argv[])
{
    ...
    if (rapower_flag == 1) {
        ...
        read_count++;
        if (metern_flag == 1) {
            printf("%d_VAR(%3.6f*VAR)\n", device_address, rapower);
        } else if (compact_flag == 1) {
            printf("%3.6f ", rapower);
        } else {
            printf("Reactive Power: %3.6f VAR \n", rapower);
        }
    }
    ...
    if (pangle_flag == 1) {
        ...
        if (metern_flag == 1) {
            ...
            printf("Phase Angle: %3.6f Degree \n", pangle);
        }
    }
